...
<html lang="en">
  <head>
    ...
    <meta
      name="description"
      content="EasyNet: In Business Communications provides IT solutions with various IT services and products."
    />
    ...
    <header>
      ...
      <div id="right">
        ...
        <div id="right-item">
          ...
          /></a>
          <a href ="checkout.html"><img id="icons_bag" class="active" src="_images/_icons/bag.png" width="30px"></a>
        </div>
      ...
      <div class="checkout_boxes">
        ...
        <div class="checkbox1">
          <a href="prodinfo.html"
              ...
              <div id="check_quantity">
                <input class="cart_quantity" type="number" value="1">
                <button class="btn_danger" id="rem_button">Remove from Cart</button></div>
        </div>    
      </div>
      <div id="total_price">
        <h1>Total Price:</h1>
